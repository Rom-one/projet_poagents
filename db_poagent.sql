...
--
-- Client: localhost
-- Généré le: Sam 07 Décembre 2013 à 10:52
...
CREATE TABLE `objet` (
  ...
  `marge` decimal(6,0) NOT NULL DEFAULT '15',
...
INSERT INTO `objet` (`refObjet`, `nomObjet`, `motCle`, `marge`, `idCategorie`) VALUES
...
--
ALTER TABLE `vente`
  ADD CONSTRAINT `fk_vente_idStock` FOREIGN KEY (`idStock`) REFERENCES `stock` (`idStock`) ON DELETE NO ACTION ON UPDATE NO ACTION,
